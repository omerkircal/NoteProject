...
namespace NoteProject.BusinessLayer
{
    public class EvernoteUserManager : ManagerBase<EvernoteUser>
    {
        ...
        {
            //Method hiding...
            //override : base deki metodun dönüş tipi değişmez ve mutlaka kodun içerisinde return base.Insert() yazılması gerekli.
            //new : yepyeni bir metoda sahip oluyoruz. Böylece base deki method unutuluyor. 
